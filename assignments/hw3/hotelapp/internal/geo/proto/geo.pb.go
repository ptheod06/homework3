...
type GeoClient interface {
	GetGeo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *geoClient) GetGeo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := grpc.Invoke(ctx, "/geo.Geo/GetGeo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GeoServer interface {
	GetGeo(context.Context, *Request) (*Result, error)
}
...
func _Geo_GetGeo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GeoServer).GetGeo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/geo.Geo/GetGeo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeoServer).GetGeo(ctx, req.(*Request))
	}
...
var fileDescriptor0 = []byte{
	...
	0x8b, 0xd9, 0x3d, 0x35, 0x5f, 0x48, 0x99, 0x8b, 0xcd, 0x3d, 0xb5, 0x04, 0xc4, 0xe2, 0xd1, 0x03,
	0x59, 0x0b, 0xb5, 0x48, 0x8a, 0x1b, 0xca, 0x03, 0x99, 0x93, 0xc4, 0x06, 0x76, 0x8c, 0x31, 0x20,
	0x00, 0x00, 0xff, 0xff, 0x09, 0xf4, 0x62, 0x4b, 0x99, 0x00, 0x00, 0x00,
}
